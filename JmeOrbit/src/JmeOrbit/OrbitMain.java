...
public class OrbitMain extends SimpleApplication {
    ...
    private void buildScene() {
        ...
        this.earthMesh = new Sphere(64, 64, (float) (1f * OrbitMain.EARTH_R));
        ...
        Arrow xAxisMesh = new Arrow(Vector3f.UNIT_X.mult((float) (2f * OrbitMain.EARTH_R)));
        ...
        Arrow yAxisMesh = new Arrow(Vector3f.UNIT_Y.mult((float) (2f * OrbitMain.EARTH_R)));
        ...
        Arrow zAxisMesh = new Arrow(Vector3f.UNIT_Z.mult((float) (2f * OrbitMain.EARTH_R)));
        ...
        sun.setRadius((float) ((1000f * OrbitMain.SUN_D))); // NOTE!!!
        sun.setPosition(new Vector3f((float) (OrbitMain.SUN_D), 0, 0));
...
//                (float) (OrbitMain.SUN_D));
    ...
    private Geometry buildLatitudesCurve() {
        ...
        latGeo.scale((float) (OrbitMain.EARTH_R * 1.001f));
    ...
    public void simpleUpdate(float tpf) {
        ...
        float incf = (float) (0.00125f * OrbitMain.EARTH_R);
        if (this.bIncX) {
